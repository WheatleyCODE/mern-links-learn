...
var message_hook_1 = require("../hooks/message.hook");
var AuthPage = function () {
    var message = message_hook_1.useMessage();
    var auth = react_1.useContext(AuthContext_1.AuthContext);
    var _a = react_1.useState({
        email: '',
        password: ''
    }), form = _a[0], setForm = _a[1];
    var _b = http_hook_1.useHttp(), loading = _b.loading, request = _b.request, error = _b.error, clearErrors = _b.clearErrors;
    react_1.useEffect(function () {
        console.log(error);
        message(error);
        clearErrors();
    }, [error, message, clearErrors]);
    var registerHadler = function () { return __awaiter(void 0, void 0, void 0, function () {
        var data, e_1;
    ...
    var loginHadler = function () { return __awaiter(void 0, void 0, void 0, function () {
        var data, token, userId, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
